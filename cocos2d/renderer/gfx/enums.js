...
module.exports = {
  // GL_NEAREST: GL_NEAREST,                // gl.NEAREST
  // GL_LINEAR: GL_LINEAR,                 // gl.LINEAR
  // GL_NEAREST_MIPMAP_NEAREST: GL_NEAREST_MIPMAP_NEAREST, // gl.NEAREST_MIPMAP_NEAREST
  // GL_LINEAR_MIPMAP_NEAREST: GL_LINEAR_MIPMAP_NEAREST,  // gl.LINEAR_MIPMAP_NEAREST
  // GL_NEAREST_MIPMAP_LINEAR: GL_NEAREST_MIPMAP_LINEAR,  // gl.NEAREST_MIPMAP_LINEAR
  // GL_LINEAR_MIPMAP_LINEAR: GL_LINEAR_MIPMAP_LINEAR,   // gl.LINEAR_MIPMAP_LINEAR

  // //  GL_BYTE : 5120,                  // gl.BYTE
  // GL_UNSIGNED_BYTE: GL_UNSIGNED_BYTE,            // gl.UNSIGNED_BYTE
  // //  GL_SHORT : 5122,                 // gl.SHORT
  // GL_UNSIGNED_SHORT: GL_UNSIGNED_SHORT,           // gl.UNSIGNED_SHORT
  // GL_UNSIGNED_INT: GL_UNSIGNED_INT,             // gl.UNSIGNED_INT
  // GL_FLOAT: GL_FLOAT,                    // gl.FLOAT
  // GL_UNSIGNED_SHORT_5_6_5: GL_UNSIGNED_SHORT_5_6_5,    // gl.UNSIGNED_SHORT_5_6_5
  // GL_UNSIGNED_SHORT_4_4_4_4: GL_UNSIGNED_SHORT_4_4_4_4,  // gl.UNSIGNED_SHORT_4_4_4_4
  // GL_UNSIGNED_SHORT_5_5_5_1: GL_UNSIGNED_SHORT_5_5_5_1,  // gl.UNSIGNED_SHORT_5_5_5_1
  // GL_HALF_FLOAT_OES: GL_HALF_FLOAT_OES,          // gl.HALF_FLOAT_OES

  // GL_DEPTH_COMPONENT: GL_DEPTH_COMPONENT, // gl.DEPTH_COMPONENT

  // GL_ALPHA: GL_ALPHA,            // gl.ALPHA
  // GL_RGB: GL_RGB,              // gl.RGB
  // GL_RGBA: GL_RGBA,             // gl.RGBA
  // GL_LUMINANCE: GL_LUMINANCE,        // gl.LUMINANCE
  // GL_LUMINANCE_ALPHA: GL_LUMINANCE_ALPHA,  // gl.LUMINANCE_ALPHA

  // GL_COMPRESSED_RGB_S3TC_DXT1_EXT: GL_COMPRESSED_RGB_S3TC_DXT1_EXT,   // ext.COMPRESSED_RGB_S3TC_DXT1_EXT
  // GL_COMPRESSED_RGBA_S3TC_DXT1_EXT: GL_COMPRESSED_RGBA_S3TC_DXT1_EXT,  // ext.COMPRESSED_RGBA_S3TC_DXT1_EXT
  // GL_COMPRESSED_RGBA_S3TC_DXT3_EXT: GL_COMPRESSED_RGBA_S3TC_DXT3_EXT,  // ext.COMPRESSED_RGBA_S3TC_DXT3_EXT
  // GL_COMPRESSED_RGBA_S3TC_DXT5_EXT: GL_COMPRESSED_RGBA_S3TC_DXT5_EXT,  // ext.COMPRESSED_RGBA_S3TC_DXT5_EXT

  // GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG: GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG,  // ext.COMPRESSED_RGB_PVRTC_4BPPV1_IMG
  // GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG: GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG,  // ext.COMPRESSED_RGB_PVRTC_2BPPV1_IMG
  // GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG: GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG, // ext.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG
  // GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG: GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG, // ext.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG

  // GL_COMPRESSED_RGB_ETC1_WEBGL: GL_COMPRESSED_RGB_ETC1_WEBGL, // ext.COMPRESSED_RGB_ETC1_WEBGL

  // GL_COMPRESSED_RGB8_ETC2: GL_COMPRESSED_RGB8_ETC2,       // ext.COMPRESSED_RGB8_ETC2
  // GL_COMPRESSED_RGBA8_ETC2_EAC: GL_COMPRESSED_RGBA8_ETC2_EAC,  // ext.COMPRESSED_RGBA8_ETC2_EAC
  //////////////////////////////
  enums,
  attrTypeBytes,
  glFilter,
