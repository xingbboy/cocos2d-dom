...
const valueTypes = require('../core/value-types');
const Vec2 = valueTypes.Vec2;
const Vec3 = valueTypes.Vec3;
const Vec4 = valueTypes.Vec4;
const Color = valueTypes.Color;
const Mat4 = valueTypes.Mat4;
const Texture2D = require('../core/assets/CCTexture2D');
const gfxTexture2D = require('./gfx/texture-2d');
const gfxTextureCube = require('./gfx/texture-cube');
